 ...
 */
final class Version20240108095253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire CHANGE destinaton_id idport INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire CHANGE idport destinaton_id INT DEFAULT NULL');
    }
}
